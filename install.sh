...
echo "   alias c1='ANTHROPIC_BASE_URL=\"https://kimi-router.your-domain.com\" ANTHROPIC_API_KEY=\"key1\" ANTHROPIC_MODEL=\"moonshotai/kimi-k2\" ANTHROPIC_SMALL_FAST_MODEL=\"google/gemini-2.5-flash\" claude'"
